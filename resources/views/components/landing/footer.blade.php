<footer class="w-full text-gray-700 bg-gray-50 body-font">
    <div
        class="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
        <div class="flex-shrink-0 mx-auto text-center md:mx-0 md:text-left">
    ...
    <div class="bg-gray-200">
        <div class="container px-5 py-4 mx-auto">
            <p class="text-sm text-gray-700 capitalize xl:text-center">© {{ date('Y') }} All rights reserved </p>
        </div>
    </div>
</footer>
